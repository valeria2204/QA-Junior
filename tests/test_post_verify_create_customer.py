...
def test_C2TC7_POST_validar_schema_crear_nueva_cuenta_customer_solo_con_la_informacion_valida_requerida(
...
def test_C2TC8_POST_validar_schema_crear_nueva_cuenta_customer_con_todo_el_esquema_llenado(get_body_of_create_a_customer_with_full_information):
