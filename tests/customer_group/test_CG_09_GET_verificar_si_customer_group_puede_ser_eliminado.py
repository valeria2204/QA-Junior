...
from tests.customer_group.setup import send_request_of_check_if_customer_group_can_be_deleted_with_group_id
...
def test_CG9TC1_GET_verificar_si_un_customer_group_no_asignado_a_un_customer_puede_ser_eliminado(setup_data):
    response_json = send_request_of_check_if_customer_group_can_be_deleted_with_group_id("0", "GET", TestData.token)
...
def test_CG9TC2_GET_verificar_si_un_customer_group_puede_ser_eliminado_cuando_el_id_es_no_existente(setup_data):
    response_json = send_request_of_check_if_customer_group_can_be_deleted_with_group_id("1000")
    assert_response_status(TestData.response_status_code, 404)
    assert response_json["parameters"]["fieldValue"] == 1000


@pytest.mark.functional
@pytest.mark.regression
def test_CG9TC3_GET_verificar_si_un_customer_group_puede_ser_eliminado_cuando_el_id_vacio(setup_data):
    send_request_of_check_if_customer_group_can_be_deleted_with_group_id("")
...
def test_CG9TC4_GET_verificar_si_un_customer_group_asignado_a_un_customer_puede_ser_eliminado(setup_data):
    response_json = send_request_of_check_if_customer_group_can_be_deleted_with_group_id("2")
    assert_response_status(TestData.response_status_code, 200)
    assert str(response_json) is "False"


@pytest.mark.functional
@pytest.mark.regression
def test_CG9TC5_GET_verificar_si_un_customer_group_puede_ser_eliminado_cuando_el_id_es_de_tipo_texto(setup_data):
    send_request_of_check_if_customer_group_can_be_deleted_with_group_id("sss")
    assert_response_status(TestData.response_status_code, 400)
...
def test_CG9TC12_GET_verificar_si_un_customer_group_puede_ser_eliminado_cuando_se_usa_el_metodo_post(setup_data):
    send_request_of_check_if_customer_group_can_be_deleted_with_group_id("1", "POST")
    assert_response_status(TestData.response_status_code, 404)


@pytest.mark.regression
def test_CG9TC13_GET_verificar_si_un_customer_group_puede_ser_eliminado_cuando_se_usa_el_metodo_put(setup_data):
    send_request_of_check_if_customer_group_can_be_deleted_with_group_id("1", "PUT")
    assert_response_status(TestData.response_status_code, 404)


@pytest.mark.regression
def test_CG9TC14_GET_verificar_si_un_customer_group_puede_ser_eliminado_cuando_se_usa_el_metodo_delete(setup_data):
    send_request_of_check_if_customer_group_can_be_deleted_with_group_id("1", "DELETE")
    assert_response_status(TestData.response_status_code, 404)
...
def test_CG9TC8_GET_verificar_esquema_verificar_si_un_customer_group_puede_ser_eliminado_cuando_el_id_es_no_existente(setup_data):
    response_json = send_request_of_check_if_customer_group_can_be_deleted_with_group_id("1000")
    assert_schemas(response_json, 'response_status_code_404_no_such_entity.json')
    assert response_json["message"] == 'No such entity with %fieldName = %fieldValue'
    assert response_json["parameters"]["fieldName"] == "groupId"


@pytest.mark.regression
def test_CG9TC9_GET_verificar_esquema_verificar_si_un_customer_group_puede_ser_eliminado_cuando_el_id_vacio(setup_data):
    response_json = send_request_of_check_if_customer_group_can_be_deleted_with_group_id("")
    assert_schemas(response_json, 'response_status_code_400_type_value_is_invalid.json')
    assert TestData.response_status_code == 400
    assert response_json["message"] == "The \"\" value's type is invalid. The \"int\" type was expected. Verify and try again."
...
def test_CG9TC10_GET_verificar_esquema_verificar_si_un_customer_group_puede_ser_eliminado_cuando_el_id_es_de_tipo_texto(setup_data):
    response_json = send_request_of_check_if_customer_group_can_be_deleted_with_group_id("texto")
    assert_schemas(response_json, 'response_status_code_400_type_value_is_invalid.json')
    assert TestData.response_status_code == 400
    assert response_json["message"] == "The \"texto\" value's type is invalid. The \"int\" type was expected. Verify and try again."
...
def test_CG9TC15_GET_verificar_esquema_verificar_si_un_customer_group_puede_ser_eliminado_cuando_el_token_no_tiene_permisos(setup_data):
    response_json = send_request_of_check_if_customer_group_can_be_deleted_with_group_id("1", "GET", TestData.token_no_valid)
    assert_schemas(response_json, 'response_status_code_400_type_value_is_invalid.json')
    assert TestData.response_status_code == 401
    assert response_json["message"] == "The consumer isn't authorized to access %resources."
    assert response_json["parameters"]["resources"] == "Magento_Customer::group"
...
def test_CG9TC16_GET_verificar_esquema_verificar_si_un_customer_group_puede_ser_eliminado_cuando_se_usa_el_metodo_post(setup_data):
    response_json = send_request_of_check_if_customer_group_can_be_deleted_with_group_id("1", "POST")
...
def test_CG9TC17_GET_verificar_esquema_verificar_si_un_customer_group_puede_ser_eliminado_cuando_se_usa_el_metodo_put(setup_data):
    response_json = send_request_of_check_if_customer_group_can_be_deleted_with_group_id("1", "PUT")
    assert_schemas(response_json, 'response_status_code_404_request_does_not_match.json')
    assert response_json["message"] == "Request does not match any route."
...
def test_CG9TC18_GET_verificar_esquema_verificar_si_un_customer_group_puede_ser_eliminado_cuando_se_usa_el_metodo_delete(setup_data):
    response_json = send_request_of_check_if_customer_group_can_be_deleted_with_group_id("1", "DELETE")
    assert_schemas(response_json, 'response_status_code_404_request_does_not_match.json')
    assert response_json["message"] == "Request does not match any route."
