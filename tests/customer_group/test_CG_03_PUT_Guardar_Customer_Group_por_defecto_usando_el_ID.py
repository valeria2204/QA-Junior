...
from tests.customer_group.setup import setup_module_customer_group
...
@pytest.mark.smoke
def test_CG03TC1_PUT_status_code_200_valido(setup_module_customer_group):
...
@pytest.mark.smoke
def test_CG03TC2_PUT_asignar_predeterminado_a_uno_ya_predeterminado(setup_module_customer_group):
    send_request_of_update_customer_group_default(1)
    assert_response_status(TestData.response_status_code, 200)

@pytest.mark.smoke
def test_CG03TC3_PUT_status_code_401_sin_autenticacion(setup_module_customer_group):
...
@pytest.mark.smoke
def test_CG03TC4_PUT_status_code_404_no_existente(setup_module_customer_group):
...
def test_CG03TC5_PUT_status_code_400_id_invalido_texto(setup_module_customer_group):
...
@pytest.mark.functional
def test_CG03TC6_PUT_status_code_400_id_invalido_simbolos(setup_module_customer_group):
    send_request_of_update_customer_group_default(StaticData.symbols.value)
    assert_response_status(TestData.response_status_code, 400)

@pytest.mark.functional
def test_CG03TC7_PUT_status_code_400_id_vacio(setup_module_customer_group):
    send_request_of_update_customer_group_default(StaticData.empty_name.value)
    assert_response_status(TestData.response_status_code, 400)

@pytest.mark.functional
def test_CG03TC8_GET_en_vez_de_PUT(setup_module_customer_group):
    send_request_of_update_customer_group_default(StaticData.empty_name.value, None, Method.GET.value)
    assert_response_status(TestData.response_status_code, 200)

@pytest.mark.functional
def test_CG03TC9_DELETE_en_vez_de_PUT(setup_module_customer_group):
    send_request_of_update_customer_group_default(StaticData.empty_name.value, None, Method.DELETE.value)
    assert_response_status(TestData.response_status_code, 400)

@pytest.mark.functional
def test_CG03TC10_POST_en_vez_de_PUT(setup_module_customer_group):
    send_request_of_update_customer_group_default(StaticData.empty_name.value, None, Method.POST.value)
    assert_response_status(TestData.response_status_code, 404)

@pytest.mark.regression
def test_CG03TC11_verificar_que_la_asignacion_de_un_customer_group_preterminado_no_afecta_obtener_customers_existentes_con_customer_group_no_predeterminados(
